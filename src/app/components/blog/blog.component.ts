...
listNews: any[] = [
    {
      ...
      texto: "<p>Muchas veces asociamos la puesta en marcha de un negocio con un proceso que se dilata mucho en el tiempo. Es cierto que algunos proyectos requieren de mucho tiempo de preparación y es necesario prestarles toda la atención que necesitan para que salgan bien. Sin embargo, también hay ideas emprendedoras que puedan estar listas en muy poco tiempo.</p><p>En los últimos meses hemos visto mucho ejemplos. La pandemia ha obligado a agudizar el ingenio y en poco tiempo han surgido muchas empresas relacionadas de una forma u otra con productos y servicios que ahora mismo son esenciales: desde negocios especializados en importación de mascarillas a servicios de canguro que se encargan de cuidar a los niños si estos tienen que hacer cuarentena y sus padres están trabajando. Vamos a ver qué podemos hacer para tener un negocio en marcha lo antes posible.</p><h2>Ajusta tu idea de negocio</h2><p>Una buena idea de negocio es aquella que es escalable o, lo que es lo mismo, que te permite hacer crecer tu negocio con el paso del tiempo. Hoy podrías ofrecer X producto o servicio, pero con el paso del tiempo podrías ir ampliando tu oferta. Pues bien, para ponerte en marcha lo antes posible debes ajustar lo máximo tu idea de negocio.</p><p>Para empezar puedes poner a disposición de los consumidores solo un producto o servicio. Si este es necesario ahora mismo y hay una buena demanda, será más que suficiente para que empieces a recuperar la inversión y obtener rentabilidad. Así, mientras ya estás ganando dinero, puedes explorar con más tranquilidad otras vías para hacer crecer tu negocio.</p>",
      fechaPubli: "3-2-2023"
    },
    {
      id: 2,
